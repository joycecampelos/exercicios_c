/*
EXERCÍCIO 18 - Faça um programa que, para um número indeterminado de pessoas: leia a idade de cada pessoa, sendo que a leitura da idade zero indica o fim dos dados e não deve ser contabilizada. Calcule e escreva:
